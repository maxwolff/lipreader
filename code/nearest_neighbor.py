...
masterFolder = '/Users/wamsood/Desktop/phoneme_mouth_frames_3/'
inputFolder = './input/'
...
for phoneme in phonemes:
	...
	counter = 0
	speakerCounter = collections.defaultdict(float)
	for jpegDir in jpegDirs:
		if jpegDir[-3:] != 'jpg': continue
		if counter == 50: break
		specs = re.split('\_', jpegDir)
		speakerCounter[specs[0]] += 1
		if speakerCounter[specs[0]] > 2: continue
		if specs[2] == phoneme:
